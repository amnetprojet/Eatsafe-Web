...
export function Contact() {
  ...
  const [state, handleSubmit] = useForm("xpwrjwlj");
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="flex items-center space-x-3 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">+221 78 167 96 48</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                  <Phone className="w-6 h-6 text-blue-600 dark:text-blue-400" />
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white">Support Urgence</p>
                    <p className="text-gray-600 dark:text-gray-300">+221 77 186 05 45</p>
                  </div>
                </div>
              </div>
            </motion.div>
